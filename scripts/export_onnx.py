...
"""Export a fixed-width Inflect core and a dynamic waveform decoder."""
import sys
...
class PaddedSynthesisCore(torch.nn.Module):
    """Run the shape-sensitive encoder/flow on a fixed token window."""
...
def main() -> None:
    ...
    torch.onnx.export(
        core,
        (tokens, lengths, noise),
        output / "inflect-core.onnx",
        opset_version=18,
